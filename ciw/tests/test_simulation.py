...
#     Number_of_classes = draw(integers(min_value=1, max_value=10))
#     Number_of_nodes = draw(integers(min_value=1, max_value=10))
#     class_names = ['Class ' + str(i) for i in range(Number_of_classes)]
#     Arrival_rates = draw(fixed_dictionary({cls:lists(min_size=Number_of_nodes,
#                                                      max_size=Number_of_nodes)
#                                                      for cls in class_names}))
#     Service_rates = draw(fixed_dictionary({cls:lists(min_size=Number_of_nodes,
#                                                      max_size=Number_of_nodes)
#                                                      for cls in class_names}))
